...
namespace old_stuff_exchange_v2.Migrations
{
    ...
    [Migration("20220611114332_update-date")]
            ...
            modelBuilder.Entity("old_stuff_exchange_v2.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 11, 18, 43, 32, 386, DateTimeKind.Local).AddTicks(2805));
                    ...
                    b.Property<DateTime>("LastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 11, 18, 43, 32, 386, DateTimeKind.Local).AddTicks(3367));
            ...
            modelBuilder.Entity("old_stuff_exchange_v2.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 11, 18, 43, 32, 388, DateTimeKind.Local).AddTicks(7258));
            ...
            modelBuilder.Entity("old_stuff_exchange_v2.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 11, 18, 43, 32, 382, DateTimeKind.Local).AddTicks(2919));
            ...
            modelBuilder.Entity("old_stuff_exchange_v2.Entities.Wallet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 11, 18, 43, 32, 388, DateTimeKind.Local).AddTicks(4555));
                    ...
                    b.Property<DateTime>("LastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 11, 18, 43, 32, 388, DateTimeKind.Local).AddTicks(4898));
