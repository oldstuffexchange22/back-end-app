...
namespace old_stuff_exchange_v2.Migrations
{
    ...
    [Migration("20220610111233_up-deposit-v2")]
    partial class updepositv2
    {
            ...
            modelBuilder.Entity("old_stuff_exchange_v2.Entities.Deposit", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2022, 6, 10, 18, 12, 33, 270, DateTimeKind.Local).AddTicks(8917));
            ...
            modelBuilder.Entity("old_stuff_exchange_v2.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 10, 18, 12, 33, 269, DateTimeKind.Local).AddTicks(398));
            ...
            modelBuilder.Entity("old_stuff_exchange_v2.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 10, 18, 12, 33, 271, DateTimeKind.Local).AddTicks(4771));
            ...
            modelBuilder.Entity("old_stuff_exchange_v2.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 10, 18, 12, 33, 265, DateTimeKind.Local).AddTicks(2745));
            ...
            modelBuilder.Entity("old_stuff_exchange_v2.Entities.Wallet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 10, 18, 12, 33, 271, DateTimeKind.Local).AddTicks(2200));
                    ...
                    b.Property<DateTime>("LastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 10, 18, 12, 33, 271, DateTimeKind.Local).AddTicks(2584));
